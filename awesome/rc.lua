...
local function brightness_control(inc)
    awful.spawn("xrandr --output eDP --brightness " .. inc, false)
end
...
globalkeys = my_table.join(
    ...
    awful.key({altkey}, "space", function () kbdcfg.switch_next() end),
    ...
    -- super + shift + ...
    awful.key({ modkey   }, "Return", function() awful.util.spawn( filemanager ) end),
    ...
    -- alt + ...
    awful.key({ altkey, "Shift"   }, "t", function () awful.spawn.with_shell( "variety -t  && wal -i $(cat $HOME/.config/variety/1/wallpaper.jpg.txt)&" ) end,
 ...
 -- Show/Hide Systray
    ...
    -- Brightness
    awful.key({}, "XF86MonBrightnessUp", function () brightness_control("0.1 +") end,
              {description = "increase brightness", group = "hotkeys"}),
    awful.key({}, "XF86MonBrightnessDown", function () brightness_control("0.1 -") end,
